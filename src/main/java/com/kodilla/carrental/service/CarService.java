...
import com.kodilla.carrental.exception.CreatingObjectWithIdException;
...
public class CarService {
    ...
    public CarDto create(final CarDto carDto) throws CreatingObjectWithIdException {
        if(carDto.getId() != 0) throw new CreatingObjectWithIdException(Car.class, carDto.getId());
